...
private let logger = Logger(subsystem: "com.Library.LibraryKit", category: "API+Authorization")
...
public extension APIClient {
    func openIDLoginURL(verifier: String) async throws -> URL {
        ...
        let request = try await request(APIRequest<APIClient.EmptyResponse>(
            ...
            method: .get,
            query: [
                URLQueryItem(name: "client_id", value: "Library"),
                URLQueryItem(name: "redirect_uri", value: "Library://callback"),
