...
public final class ItemCollection: Item, @unchecked Sendable {
    ...
    required     init(from decoder: Decoder) throws {
        ...
        // Decoding `[Item]` directly would discard subclass fields because
        // Swift's Codable always instantiates the declared static type.
        // Route through `AnyItem`, which dispatches on `ItemIdentifier.type`
