...
extension LibrarySchema {
    @Model
    public final class PersistedBook {
        #Index<PersistedBook>([\._id], [\.name])
        #Unique<PersistedBook>([\._id])
        ...
        public init(id: ItemIdentifier, name: String, authors: [String], overview: String? = nil, genres: [String], addedAt: Date, released: String? = nil, size: Int64?, subtitle: String? = nil, narrators: [String], series: [Audiobook.SeriesFragment], explicit: Bool, abridged: Bool) {
            _id = id.description
