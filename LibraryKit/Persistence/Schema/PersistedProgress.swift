...
extension LibrarySchema {
    ...
    public final class PersistedProgress {
        ...
        public init(id: String, connectionID: String, primaryID: String, groupingID: String?, progress: Percentage, startedAt: Date? = nil, lastUpdate: Date, finishedAt: Date? = nil, status: SyncStatus) {
            self.id = id
