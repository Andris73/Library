...
typealias DiscoveredConnection = LibrarySchema.PersistedDiscoveredConnection
...
extension PersistenceManager {
    ...
    public final actor AuthorizationSubsystem: Sendable {
        ...
        private let connectionService = "com.Library.credentials.v2" as CFString
        private let tlsCertificateService = "com.Library.credentials.tlsCertificate.v2" as CFString

        private let accessTokenService = "com.Library.credentials.accessToken.v2" as CFString
        private let refreshTokenService = "com.Library.credentials.refreshToken.v2" as CFString

        private let logger = Logger(subsystem: "com.Library.LibraryKit", category: "Authorization")
        ...
        nonisolated static let debugKeychainServices: [String] = [
            "com.Library.credentials.v2",
            "com.Library.credentials.tlsCertificate.v2",
            "com.Library.credentials.accessToken.v2",
            "com.Library.credentials.refreshToken.v2",
        ]
