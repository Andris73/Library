...
extension PersistenceManager {
    ...
    public final class WebSocketSubsystem {
        ...
        private let logger = Logger(subsystem: "com.Library.LibraryKit", category: "WebSocketSubsystem")
...
private final class SocketConnection {
    let logger = Logger(subsystem: "com.Library.LibraryKit", category: "WebSocketConnection")
