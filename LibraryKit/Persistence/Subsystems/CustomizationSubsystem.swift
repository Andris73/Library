...
typealias PersistedTabCustomization = LibrarySchema.PersistedTabCustomization

extension PersistenceManager {
    @ModelActor
    public final actor CustomizationSubsystem: Sendable {
        let logger = Logger(subsystem: "com.Library.LibraryKit", category: "CustomizationSubsystem")
    }
}
