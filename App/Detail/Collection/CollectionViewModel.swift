...
final class CollectionViewModel {
    private let logger = Logger(subsystem: "com.Library.Library", category: "CollectionViewModel")
    ...
    private(set) var highlighted: Audiobook?
...
extension CollectionViewModel {
    ...
    func refresh() {
        Task {
            try? await Library.refreshItem(itemID: collection.id)
            updateHighlighted()
        }
    }
}
