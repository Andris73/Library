...
final class SearchViewModel {
    let logger = Logger(subsystem: "com.Library.Library", category: "SearchPanel")
    ...
    func performSearch() {
        ...
        debounceTask = Task {
            ...
            do {
                result = try await LibraryKit.globalSearch(query: search, includeOnlineSearchResults: true)
            } catch {
